(function (global, factory) {
    ...
    utils_hooks__hooks.copyLocale            = function (locale) {
        locales.custom = new Locale();
        for (var key in locales[locale]) {
            if (locales[locale].hasOwnProperty(key)) {
                locales.custom[key] = locales[locale][key];
            }
        }
        locales.custom._abbr = "custom";
    };
    ...
    var en = _moment__default.defineLocale('en', {
